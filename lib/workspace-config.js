...
var WorkspaceConfig = function () {
  ...
  _createClass(WorkspaceConfig, [{
      ...
      return regeneratorRuntime.async(function load$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              kwsJsonPath = _findUp2.default.sync("kaltura-ws.json", { cwd: process.cwd() });
              ...
              _npmlog2.default.error("file 'kaltura-ws.json' is missing, aborting command.");
              process.exit(1);
            ...
            case 5:
              ...
              this.rootPath = _path2.default.dirname(kwsJsonPath);
              _npmlog2.default.verbose("rootPath", this.rootPath);
              this._kwsJsonPath = kwsJsonPath;
              this._kwsConfig = _loadJsonFile2.default.sync(kwsJsonPath);
              _npmlog2.default.silly('kaltura-ws', this._kwsConfig);

              this.version = this._kwsConfig.version;
              this.licenses = this._kwsConfig.licenses || null;

              _npmlog2.default.verbose("checking competability of kws version " + this.kwsVersion + " with config version " + this.version);
              if (!_semver2.default.satisfies(this.kwsVersion, "^" + this.version)) {
                _npmlog2.default.error("Major version mismatch: The current version '@kaltura-ng/dev-workspace' is " + this.kwsVersion + ", but the version in 'kaltura-ws.json' is " + this.version + ". You can either update your json file or install '@kaltura-ng/dev-workspace@" + this.version + "'");
                process.exit(1);
              }
    ...
    key: "getKWSCommandValue",
    value: function getKWSCommandValue(path) {
    ...
    key: "updateKWSConfig",
    value: function updateKWSConfig(data) {
      objectAssignDeep(this._kwsConfig, data);
      _writeJsonFile2.default.sync(this._kwsJsonPath, this._kwsConfig, { indent: 2 });
    }
  }, {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              repositories = [];
              _context3.next = 4;
              return regeneratorRuntime.awrap(Promise.all((this._kwsConfig.repositories || ['.']).map(function (repositoryData) {
    ...
    value: function _createLernaJsonFile() {
      ...
      _npmlog2.default.verbose('creating file lerna.json. This file is used internally by kaltura-ng-workspace. you should avoid using lerna cli directly.');
