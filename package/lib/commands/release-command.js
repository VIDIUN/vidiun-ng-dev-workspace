...
var ReleaseCommand = function (_Command) {
  ...
  _createClass(ReleaseCommand, [{
      ...
      return regeneratorRuntime.async(function getGithubApiInfo$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              token = this.workspace.getKWSCommandValue('release.appConfig.githubToken') || this.options['gh-token'];
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              changelogComponentPath = this.workspace.getKWSCommandValue('release.changeLog.htmlPath');
    ...
    value: function updateAppConfigVersion(newVersion) {
      ...
      var appConfigPath = this.workspace.getKWSCommandValue('release.appConfig.path');
      var filePath = appConfigPath ? _findUp2.default.sync(appConfigPath, { cwd: process.cwd() }) : '';
      var appVersionKey = this.workspace.getKWSCommandValue('release.appConfig.key');
